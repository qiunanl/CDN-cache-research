...
plt.title("OPTA*(0-1) v.s. log object size Cache-size=256G")
...
OPTA_star = np.array(coalesce_admit_prob)
print type(OPTA_star)
np.savetxt('../OPTA*/256G.csv',OPTA_star,delimiter=',')
